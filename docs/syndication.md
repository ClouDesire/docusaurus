...
If you are prototyping the integration with Cloudesire, you may find useful the “**Test Events”** functionality, available in the G_eneral_ tab into Product editing page.
